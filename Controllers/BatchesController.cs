...
namespace StudentRecords.Controllers
{
    public class BatchesController : Controller
    {
        ...
        public BatchesController(StudentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Batches != null ? 
                          ...
                          Problem("Entity set 'StudentContext.Batches'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StudentContext.Batches'  is null.");
            }
            var batch = await _context.Batches.FindAsync(id);
            if (batch != null)
            {
